export default {
  ...
  Puffs: {
    heading: 'Campaigns',
    headingType: 'h2',
    entries: Array.from(new Array(3), () => ({
      mediaProps: {
        component: 'img',
        src: 'https://picsum.photos/200/600',
      },
      title: 'Tomb of Annilation',
      excerpt: 'It is normally played indoors with the participants seated around a tabletop. A typical Dungeons & Dragons game consists of an "adventure" in a fantasy world or "campaign setting". Typically, each player controls only a single ', // prettier-ignore
      ctaPrimary: {
        url: '/foo',
